...
class UHD_N210_fosphor_NO_FIR(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, gain=0):
        ...
        self.settings = Qt.QSettings("GNU Radio", "UHD_N210_fosphor_NO_FIR")
        ...
        # Variables
        ##################################################
        self.update = update = .00000001
        self.samp_1 = samp_1 = 25e6
        self.low_0 = low_0 = -125
        self.hi_0 = hi_0 = 5
        self.gain_0 = gain_0 = 0
        self.freq_1 = freq_1 = 434.3e6
        ...
        # Blocks
        ##################################################
        self._update_range = Range(.00000001, .05, .0000005, .00000001, 200)
        ...
        self._samp_1_range = Range(.3e6, 61.44e6, 1e6, 25e6, 200)
        ...
        self._gain_0_range = Range(0, 60, 1, 0, 200)
        ...
        self._freq_1_range = Range(50e6, 3000e6, 100e3, 434.3e6, 200)
        ...
        self._fft_0_range = Range(1024, 8192, 1024, 4096, 200)
        ...
        self.uhd_usrp_source_0_0.set_bandwidth(samp_1, 0)
    ...
    def set_samp_1(self, samp_1):
        ...
        self.uhd_usrp_source_0_0.set_bandwidth(self.samp_1, 0)
...
def main(top_block_cls=UHD_N210_fosphor_NO_FIR, options=None):
    if options is None:
