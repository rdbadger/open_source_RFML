...
class record_live25msps(gr.top_block):

    def __init__(self, antenna="RX2", args="", filename="", freq=428.00e6, gain=6, samp_rate=25e6, seconds=5, subdev=""):
...
def argument_parser():
    ...
    parser.add_argument(
        "--freq", dest="freq", type=eng_float, default="428.0M",
        help="Set freq [default=%(default)r]")
    parser.add_argument(
        "--gain", dest="gain", type=eng_float, default="6.0",
        help="Set gain [default=%(default)r]")
    parser.add_argument(
        "--samp-rate", dest="samp_rate", type=eng_float, default="25.0M",
        help="Set samp_rate [default=%(default)r]")
    parser.add_argument(
        "--seconds", dest="seconds", type=eng_float, default="5.0",
        help="Set seconds [default=%(default)r]")
    return parser


def main(top_block_cls=record_live25msps, options=None):
    if options is None:
