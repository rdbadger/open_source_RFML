...
class load_pic_v2_2(QtWidgets.QWidget):
    ...
    def readFilesPressed(self):
        ...
        for idx, item in enumerate(self.items):
            ...
            if not os.path.exists('./data/{}/bound-plots'.format(self.data_folder_name)):
                os.mkdir('./data/{}/bound-plots'.format(self.data_folder_name))

            plt.savefig('./data/{}/bound-plots/{}.png'.format(self.data_folder_name, self.fn))
    ...
    def buttonPressed(self):
        ...
        for idx, item in enumerate(chopped):
            ...
            if chop.shape[0] == row and chop.shape[1] == col:
                path = './data/{}/chopped-data-{}-{}'.format(self.data_folder_name, self.widthText.text(),
