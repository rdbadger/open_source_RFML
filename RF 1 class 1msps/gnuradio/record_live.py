...
class record_live(gr.top_block):

    def __init__(self, antenna="RX2", args="", filename="", freq=433.65e6, gain=10, samp_rate=1e6, seconds=2, subdev=""):
...
def argument_parser():
    ...
    parser.add_argument(
        "--gain", dest="gain", type=eng_float, default="10.0",
        help="Set gain [default=%(default)r]")
    parser.add_argument(
        "--samp-rate", dest="samp_rate", type=eng_float, default="1.0M",
        help="Set samp_rate [default=%(default)r]")
    parser.add_argument(
        "--seconds", dest="seconds", type=eng_float, default="2.0",
        help="Set seconds [default=%(default)r]")
    return parser


def main(top_block_cls=record_live, options=None):
    if options is None:
